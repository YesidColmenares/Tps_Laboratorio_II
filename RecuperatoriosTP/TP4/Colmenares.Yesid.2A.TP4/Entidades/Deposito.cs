...
namespace Entidades
{
        ...
        where T : Producto
    {
        ...
        /// <summary>
        /// Analiza el porcentaje de productos de Mercado Libre que hay en el deposito
        /// </summary>
        /// <returns>string</returns>
        public string PorcentajeProductosMercadoLibre()
        {
            StringBuilder sb = new StringBuilder();
            int cantidad = 0;
            float porcentaje = 0;
            ...
            sb.Append($"El porcentaje de productos Mercado Libre que hay en el deposito es de: {porcentaje}%");

            return sb.ToString();
        }

        /// <summary>
        /// Analiza el porcentaje de productos de Amazon que hay en el deposito
        /// </summary>
        /// <returns>string</returns>
        public string PorcentajeProductosAmazon()
        {
            StringBuilder sb = new StringBuilder();
            int cantidad = 0;
            float porcentaje = 0;
            ...
            sb.Append($"El porcentaje de productos Amazon que hay en el deposito es de: {porcentaje}%");
